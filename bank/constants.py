...
DEBT_PAYMENTS = re.compile(r'(TARJ CRED|LINEA DE CREDITO|TARJETA DE CREDITO|TARJ.CRED.|PAGO TC|PAGO TARJETA DE CREDITO|PAGO DE LINEA DE CRED|LINEA DE CRED)', re.IGNORECASE)
